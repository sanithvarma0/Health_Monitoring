...
temperature = st.number_input("Temperature (°F)", min_value=60, max_value=120, value=98)
heart_rate = st.number_input("Heart Rate (bpm)", min_value=40, max_value=200, value=80)
pulse = st.number_input("Pulse", min_value=40, max_value=200, value=70)
...
respiratory_rate = st.number_input("Respiratory Rate (breaths per minute)", min_value=10, max_value=60, value=20)
oxygen_saturation = st.number_input("Oxygen Saturation (decimal)", min_value=0.0, max_value=1.0, value=0.95)
ph = st.number_input("PH Level (decimal)", min_value=6.0, max_value=20.0, value=7.4)
